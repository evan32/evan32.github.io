...
### Linear Regression to compare resulting covid case and test rate to otehr factors
```{r}

#Need 2 cases : X and Y are both case and/or test rate, X is race/income and Y is case/test rate
